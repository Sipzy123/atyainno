  ...
  const mainServices = [
    {
      ...
      desc: 'Enterprise-grade, scalable software solutions built from scratch to solve your unique business challenges.',
      features: ['Enterprise Applications', 'Desktop Software', 'Business Automation', 'Scalable Architecture'],
      color: '#F5C518',
    },
    {
      icon: '◉',
      title: 'Mobile App Development',
      desc: 'Native iOS, Android and cross-platform apps that deliver exceptional user experiences.',
    ...
    },
    {
      ...
      desc: 'Modern, fast and responsive web applications built with the latest frontend and backend technologies.',
      features: ['React & Vue.js', 'Node.js / Python', 'Database Design', 'DevOps & CI/CD'],
      color: '#F5C518',
    },
    {
      icon: '◇',
      title: 'UI/UX Design',
      desc: 'Beautiful, user-centered interfaces that look stunning and drive conversions.',
    ...
    },
    {
      icon: '⬟',
      title: 'QA & Testing',
      desc: 'Comprehensive quality assurance across automated, manual and performance testing.',
      features: ['Automated Testing', 'Performance Testing', 'Security Testing', 'Bug Tracking'],
      color: '#F5C518',
    },
    {
      icon: '⬢',
      title: 'Cloud Solutions',
      desc: 'Cloud infrastructure, migration strategies and managed services for any scale.',
      features: ['AWS / Azure / GCP', 'Docker & Kubernetes', 'Cloud Migration', 'Cost Optimization'],
      color: '#F5C518',
    },
    {
      icon: '◎',
      title: 'Database Design',
      desc: 'Robust, optimized database architecture ensuring security, reliability and performance.',
      features: ['SQL & NoSQL', 'Database Optimization', 'Data Security', 'Data Migration'],
      color: '#F5C518',
    },
    {
      icon: '⬤',
      title: 'Business Analysis',
      desc: 'Strategic consulting and technology analysis to align IT investment with business goals.',
      features: ['Requirements Analysis', 'Gap Analysis', 'Process Optimization', 'Change Management'],
      color: '#F5C518',
    },
  ];
