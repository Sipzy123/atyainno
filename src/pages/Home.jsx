  ...
  const services = [
    {
      ...
      desc: 'Enterprise-grade applications built to scale with your business.',
    ...
    },
    {
      ...
      label: 'Mobile',
      title: 'Mobile Apps',
      desc: 'Native iOS & Android apps that users love using every day.',
    ...
    },
    {
      ...
      desc: 'Fast, responsive, and modern web applications for the future.',
      tags: ['Next.js', 'Vue', 'TypeScript'],
    },
    {
      icon: '⬟',
      label: 'Odoo ERP',
      title: 'Odoo Solutions',
      desc: 'Full Odoo ERP implementation, customization, and support.',
    ...
    },
    {
      ...
      label: 'Design',
      title: 'UI/UX Design',
      desc: 'Beautiful interfaces crafted for performance and delight.',
    ...
    },
    {
      ...
      label: 'Cloud',
      title: 'Cloud & DevOps',
      desc: 'Scalable infrastructure and continuous deployment pipelines.',
        ...
        <div className="container hero-inner">
          <div className="hero-content">
            <div className="hero-badge fade-up">
              ...
              India's Leading IT Innovation Partner
            </div>
          ...
          <div className="hero-visual fade-up fade-up-delay-2">
            <div className="hero-card-stack">
              ...
              <div className="hcs-card hcs-card-front">
                ...
                <div className="hcs-bar-chart">
                  {[60, 80, 45, 90, 70, 95, 55].map((h, i) => (
                    <div key={i} className="hcs-bar" style={{ '--h': `${h}%`, '--delay': `${i * 0.1}s` }} />
                  ))}
                </div>
      ...
      <section className="odoo-spot">
        <div className="container odoo-spot-inner">
          <div className="odoo-spot-content">
            <div className="section-label">Certified Partner</div>
            <h2 className="section-title">
