...
const integrations = [
  ...
  { name: 'Odoo',       color: '#a24689', svg: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M1.3,13.8c-0.1,0.2-0.1,0.4-0.1,0.6c0,2.1,1.7,3.8,3.8,3.8c1.3,0,2.4-0.6,3.1-1.6c0.1-0.2,0.6-0.9,0.7-1.1c0.1-0.1,0.1-0.2,0.3-0.2h1.6c-0.3,0.5-0.7,1.1-1.1,1.5c-1.1,1.3-2.7,2.1-4.5,2.1c-3.1,0-5.6-2.5-5.6-5.6c0-0.3,0-0.6,0-0.9C0,8.2,3.3,4.9,7.4,4.9c2,0,3.8,0.8,5.1,2.1c1.3,1.3,2.1,3.1,2.1,5.1c0,0.1,0,0.2,0,0.4c0,0.1,0,0.2,0,0.4c-0.1,1.2-0.5,2.4-1.1,3.4c-0.1,0.1-0.2,0.3-0.3,0.3h1.6c2.5-2.8,4.1-6.5,4.1-10.5h1.6c0,4.4-1.8,8.5-4.8,11.5c1.4,1.4,3.4,2.3,5.6,2.3c2,0,3.8-0.7,5.1-1.9l0.9,1.1c-1.6,1.4-3.7,2.2-6,2.2c-5,0-9-4-9-9c0-0.2,0-0.3,0-0.5c-0.1,1.2-0.5,2.4-1.1,3.4l-1.3-0.6c0.6-1.1,1-2.2,1.1-3.5c0-0.1,0-0.1,0-0.2c0-2-0.8-3.8-2.1-5.1C8.7,6.5,6.9,5.7,4.9,5.7C1.4,5.7-1.3,8.4-1.3,11.8C-1.3,12.5-1.1,13.2-0.8,13.8L-0.8,13.8z"/></svg> },
...
const DonutChart = () => {
  ...
  const segments = [
    ...
    { pct: 20, color: '#FFD000', label: 'Software Dev' },
    { pct: 18, color: '#C49A00', label: 'Odoo ERP' },
    { pct: 22, color: '#383838', label: 'Web Dev' },
    { pct: 15, color: '#272727', label: 'Staff Aug' },
  ];
  ...
  <div className="bento-odoo">
    <div className="odoo-pill-row">
      <div className="odoo-cert-pill">
        ...
        <div>
          <strong>Authorise Implementation</strong>
          <span>Partner</span>
        </div>
      </div>
    </div>
